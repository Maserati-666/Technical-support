        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrioritetRequest = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatusRequests", x => x.StatusRequestId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ThemeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameTheme = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DescriptionTheme = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThemeRequests", x => x.ThemeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Request_AspNetUsers_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Responses_Request_RequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Request_PrioritetId",
                table: "Request",
                column: "PrioritetId");

            migrationBuilder.CreateIndex(
                name: "IX_Request_StatusRequestId",
                table: "Request",
                column: "StatusRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_Request_ThemeId",
                table: "Request",
                column: "ThemeId");
